...
class OrdersProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orders_product" do
    assert_difference('OrdersProduct.count') do
      post orders_products_url, params: { orders_product: { order_id_id: @orders_product.order_id_id, product_id_id: @orders_product.product_id_id } }
    end
  ...
  test "should update orders_product" do
    patch orders_product_url(@orders_product), params: { orders_product: { order_id_id: @orders_product.order_id_id, product_id_id: @orders_product.product_id_id } }
