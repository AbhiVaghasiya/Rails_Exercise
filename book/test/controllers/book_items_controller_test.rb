...
class BookItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_item" do
    assert_difference('BookItem.count') do
      post book_items_url, params: { book_item: { author_id: @book_item.author_id, publisher_id: @book_item.publisher_id, title: @book_item.title } }
    end
  ...
  test "should update book_item" do
    patch book_item_url(@book_item), params: { book_item: { author_id: @book_item.author_id, publisher_id: @book_item.publisher_id, title: @book_item.title } }
