...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { book_item_id: @publisher.book_item_id, name: @publisher.name } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { book_item_id: @publisher.book_item_id, name: @publisher.name } }
